            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              >
                ...
                {activeEffect === 'laser_eyes' && (
                  ...
                  >
                    👆 사진 속 눈 부위를 클릭하여 레이저 빔을 발사하세요!
                  </Box>
                )}

                {/* Loading / Processing Indicator */}
                {(isProcessing || isGeneratingGif) && (
                  <Box
                    sx={{
                      position: 'absolute',
                      inset: 0,
                  ...
                  >
                    ...
                    <Typography variant="subtitle2" sx={{ fontWeight: 700 }}>
                      {isGeneratingGif ? '움짤(GIF) 프레임 렌더링 중...' : '밈 효과 적용 중...'}
                    </Typography>
                  </Box>
                )}
              </Card>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
              ...
              {activeEffect === 'wide' && (
                <Box>
                  ...
                  >
                    💡 &apos;움짤(GIF) 다운로드&apos;를 누르면 좌우로 위풍당당하게 걷는 바운스 짤이
                    생성됩니다!
                  </Typography>
                </Box>
              )}
