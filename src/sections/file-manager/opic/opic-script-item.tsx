  ...
  ({
    ...
    const renderActionButtons = (
      <>
        ...
        >
          {isListening ? isPreparing ? <RefreshIcon /> : <StopCircleIcon /> : <MicIcon />}
        </IconButton>
        {!isMobile && (
          <IconButton
            size="small"
      ...
      <Card
        ...
        sx={{
          ...
          bgcolor: (theme) => {
            ...
            return !testMode && isRevealed
              ? alpha(theme.palette.primary.main, 0.02)
              : 'background.paper';
          },
          boxShadow: (theme) =>
            speakingIndex ? theme.customShadows?.error : theme.customShadows?.z1,
          transition: (theme) =>
                ...
                <Box
                  ...
                  sx={{
                    ...
                    '&:hover': {
                      bgcolor: (theme) =>
                        !isAnswerRevealed
                          ? alpha(theme.palette.background.neutral, 1)
                  ...
                  {result && result.filter((r: any) => r.cWord).length > 0 && (
                    <Stack spacing={1} sx={{ mb: 2 }}>
                      <Stack direction="row" alignItems="center" justifyContent="space-between">
                        <Typography
                          variant="overline"
                          sx={{ color: 'text.secondary', fontWeight: 900, opacity: 0.8 }}
                        >
                          Match Score
                        </Typography>
                        <Typography
                          ...
                          sx={{
                            ...
                            color: (theme) => {
                              const score =
                                (result.filter((r: any) => r.isCorrect).length /
                                  result.filter((r: any) => r.cWord).length) *
                                100;
                  ...
                  >
                            ...
                            word.cWord && (
                              <Typography
                                ...
                                sx={{
                                  fontWeight: 700,
                                  color:
                                    word.isCorrect || isAnswerRevealed
                                      ? 'text.primary'
                                      : 'text.disabled',
                                  transition: (theme) =>
                                    theme.transitions.create(['color', 'filter']),
                                }}
                              >
                    ...
                    {!hideInput && (
                      <IconButton
                        ...
                        sx={{
                          ml: 0.5,
                          p: 0.5,
                          color: isAnswerRevealed ? 'primary.main' : 'text.disabled',
                        }}
                      >
                        {isAnswerRevealed ? (
                    ...
                    <IconButton
                      ...
                      sx={{
                        ml: 0.5,
                        p: 0.5,
                        color: speakingIndex ? 'primary.main' : 'primary.main',
                      }}
                    >
                      {speakingIndex ? (
            ...
            <Stack direction="row" spacing={1} alignItems="flex-start">
              <Box
                ...
                sx={{
                  ...
                  transition: (theme) =>
                    theme.transitions.create(['filter', 'opacity', 'background-color']),
                  '&:hover': {
                    bgcolor: (theme) =>
                      isRevealed ? 'transparent' : alpha(theme.palette.action.hover, 0.08),
                  },
                }}
              >
                <Typography
