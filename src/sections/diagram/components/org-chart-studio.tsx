    ...
    <TreeNode
      ...
      label={
        ...
        >
          ...
          >
            <IconButton size="small" onClick={() => handleOpenAdd(node.id)} title="하위 팀원 추가">
    ...
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          <AccountTreeRoundedIcon sx={{ color: 'primary.main', fontSize: 28 }} />
          <Box>
            <Typography variant="subtitle1" sx={{ fontWeight: 800 }}>
              조직도 & 마인드맵 스튜디오 (Org Chart Studio)
            </Typography>
