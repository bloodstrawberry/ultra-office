  ...
  return (
    ...
    >
      <svg viewBox="0 0 100 100" width="100%" height="100%">
        ...
        {/* Legs */}
        <line x1="47" y1="64" x2="44" y2="86" stroke="#1e293b" strokeWidth="4" strokeLinecap="round" />
        <line x1="53" y1="64" x2="56" y2="86" stroke="#1e293b" strokeWidth="4" strokeLinecap="round" />

        {/* Left Arm & Flag (Red & Yellow Semaphore Flag) */}
        <line x1="46" y1="42" x2={leftX} y2={leftY} stroke="#334155" strokeWidth="4" strokeLinecap="round" />
        <circle cx={leftX} cy={leftY} r="7" fill="#ef4444" stroke="#fbbf24" strokeWidth="3" />

        {/* Right Arm & Flag */}
        <line x1="54" y1="42" x2={rightX} y2={rightY} stroke="#334155" strokeWidth="4" strokeLinecap="round" />
