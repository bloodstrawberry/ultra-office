...
export const IDE_THEMES: IDETheme[] = [
  ...
  // 9. Visual Studio Classic Blue (오리지널 블루 테마)
  {
    id: 'vs-blue',
    ...
    monacoDefinition: {
      ...
      colors: {
        ...
        'editor.foreground': '#d4e2fa',
        'editorLineNumber.foreground': '#4f6182',
        'editorCursor.foreground': '#388bfd',
        'editor.selectionBackground': '#264f78',
        'editor.lineHighlightBackground': '#242b3d',
      },
    },
    terminalTheme: {
      background: '#191f2c',
