      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Top Overlay Badge / Quick Pill on Canvas */}
            {previewViewMode === 'split' && (
              <Box
                sx={{
                  position: 'absolute',
              ...
              >
                ...
                >
                  {splitOrientation === 'horizontal' ? (
                    <SwapHorizRoundedIcon sx={{ fontSize: 16, color: 'primary.light' }} />
                  ) : (
                    <SwapVertRoundedIcon sx={{ fontSize: 16, color: 'primary.light' }} />
                  )}
                ...
                <Box
                  onClick={() => setSplitMode((prev) => (prev === 'inside' ? 'outside' : 'inside'))}
                  sx={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: 0.5,
                ...
                >
                  ({Math.round(splitStart)}% ~ {Math.round(splitEnd)}%)
                </Typography>
              </Box>
            )}
