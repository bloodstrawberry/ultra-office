        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          {onAutoSolve && (
            <button
              type="button"
              onClick={onAutoSolve}
              className="px-2.5 py-0.5 bg-gradient-to-r from-amber-500 to-orange-500 hover:brightness-110 active:scale-95 text-white rounded-lg text-xs font-black cursor-pointer shadow-md flex items-center gap-1 transition-all"
              title="DFS로 맵 해결 가능 여부 및 최적 경로 탐색"
            >
              <span>🤖</span>
              <span>자동 풀이</span>
            </button>
