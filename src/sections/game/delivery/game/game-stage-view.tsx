  ...
  return (
    <div className="h-full min-h-0 flex-1 text-amber-950 flex flex-col items-center justify-start p-2 sm:p-4 relative overflow-hidden select-none w-full animate-fade-in">
      ...
      <div className="w-full max-w-4xl flex items-center justify-between z-10 py-2 sm:py-3 gap-2 shrink-0">
        ...
        <button
          type="button"
          className="px-3.5 py-2 sm:px-4 sm:py-2.5 bg-[#FFFDF6]/90 hover:bg-[#FFFDF6] active:scale-95 text-sky-900 font-black text-xs sm:text-sm rounded-2xl shadow-md border-2 border-sky-400/80 backdrop-blur-md flex items-center gap-1.5 transition-all cursor-pointer"
        >
          <span>🚚 배송지 선택</span>
        </button>
      </div>
