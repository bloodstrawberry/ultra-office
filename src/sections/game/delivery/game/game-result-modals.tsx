      ...
      <div className="w-full max-w-xs sm:max-w-sm bg-[#FFFDF6] border-4 border-amber-400 rounded-3xl p-5 sm:p-6 shadow-2xl text-amber-950 flex flex-col items-center gap-4 text-center animate-pop-in relative overflow-hidden">
        ...
        <div className="flex flex-col gap-1.5 relative z-10">
          ...
          <p className="text-xs sm:text-sm font-extrabold text-amber-800/90 leading-relaxed px-1">
            모든 목적지까지 안전하게 배송을 마쳤습니다!
            <br />
            소중한 평점과 리뷰를 남겨주시면
            <br /> 더 많은 배송지가 업데이트됩니다. 💖
          </p>
        </div>
    ...
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-amber-950/50 backdrop-blur-md animate-fade-in select-none">
      <div className="w-full max-w-xs sm:max-w-sm bg-[#FFFDF6] border-4 border-amber-400 rounded-3xl p-5 sm:p-6 shadow-2xl text-amber-950 flex flex-col items-center gap-4 text-center animate-pop-in relative overflow-hidden">
        ...
        <div className="flex flex-col items-center gap-1 relative z-10 w-full">
          <div className="px-3 py-1 bg-sky-100 border-2 border-sky-400/80 rounded-full shadow-xs inline-flex items-center gap-1 mb-0.5">
            <span className="text-xs sm:text-sm font-black text-sky-900 tracking-wider">
              배송지 {levelIndex + 1}
            </span>
          </div>
...
export function GameOverModal({
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-slate-950/50 backdrop-blur-md animate-fade-in select-none">
      <div className="w-full max-w-xs sm:max-w-sm bg-[#FFFDF6] border-4 border-rose-400/80 rounded-3xl p-5 sm:p-6 shadow-2xl text-slate-900 flex flex-col items-center gap-4 text-center animate-pop-in relative overflow-hidden">
        ...
        <div className="flex flex-col gap-1 relative z-10">
          ...
          <p className="text-xs sm:text-sm font-extrabold text-rose-800/90">
            택배차가 도로 밖으로 벗어났습니다. 다시 안전하게 배송을 출발해 보세요!
          </p>
        </div>
