...
export const BLOCK_STRAWBERRY_L = 2;
export const BLOCK_STRAWBERRY_U = 201;
export const BLOCK_STRAWBERRY_R = 202;
export const BLOCK_STRAWBERRY_D = 203;
...
export function getBaseBlockId(id: BlockId): BlockId {
  ...
  if (uniced >= 201 && uniced <= 203) {
    return BLOCK_STRAWBERRY;
  }
  return uniced;
}

export function isStrawberryBlock(id: BlockId): boolean {
  const uniced = isFrozenBlock(id) ? id - BLOCK_ICE_OFFSET : id;
