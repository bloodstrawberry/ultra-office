const aitConfig = { appName: "orbox" };

/**
 * ============================================================================
 * [GLOBAL CONSTANTS] 전역 상수 및 설정 관리 파일 (orbox)
 * ============================================================================
...
export const CURRENT_APP_NAME: string = aitConfig.appName || "orbox";
...
/** 기본 더미 로고 이미지 경로 */
export const DEFAULT_DUMMY_LOGO = "/delivery/personal-ad/dummy.png";
...
/** 블록 이동 속도 (단위: px/sec) */
export const BLOCK_SPEED_PX_PER_SEC = 600;

/** 총 스테이지 개수 */
export const MAX_STAGE_COUNT = 50;

/** 충돌 반사 탄성 계수 (1.0 = 완전 탄성 충돌) */
...
export const STORAGE_KEYS = {
  ...
  /** 사용자 사운드 설정 키 */
  SOUND_ENABLED: "orbox_sound_enabled",
  /** 게임 최고 점수 / 기록 키 */
  HIGH_SCORE: "orbox_high_score",
} as const;