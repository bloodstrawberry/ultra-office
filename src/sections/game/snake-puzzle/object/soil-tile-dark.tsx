  ...
  return (
    ...
    >
      {/* 
        1. Base fill 
      */}
      <rect x="-1" y="-1" width="102" height="102" fill="#784b31" />

      {/* 
        2. Cartoon Dirt Spots 
      */}
      <ellipse cx="22" cy="24" rx="4.5" ry="3" fill="#5a3520" opacity="0.8" />
      <ellipse cx="78" cy="18" rx="5" ry="3.5" fill="#5a3520" opacity="0.8" />
      <ellipse cx="16" cy="62" rx="4" ry="2.5" fill="#5a3520" opacity="0.8" />
      <ellipse cx="64" cy="54" rx="5.5" ry="3" fill="#5a3520" opacity="0.8" />
      <ellipse cx="42" cy="82" rx="4.5" ry="3" fill="#5a3520" opacity="0.8" />
      <ellipse cx="86" cy="76" rx="3.5" ry="2" fill="#5a3520" opacity="0.8" />
