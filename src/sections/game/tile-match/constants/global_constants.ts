/**
 * ============================================================================
 * [GLOBAL CONSTANTS] 전역 상수 및 설정 관리 파일 (tile-match)
 * ============================================================================
...
/** 현재 앱 이름 */
export const CURRENT_APP_NAME: string = 'tile-match';
...
/** 타일 매칭 기본 그리드 크기 (N x N) */
export const GRID_SIZE = 4;

/** 매칭 소거에 필요한 동일 타일 개수 */
export const REQUIRED_MATCH_COUNT = 3;

/** 스테이지당 허용되는 타일 섞기(Shuffle) 최대 횟수 */
export const SHUFFLE_LIMIT_COUNT = 3;
...
export const STORAGE_KEYS = {
  ...
  /** 사용자 사운드 설정 키 */
  SOUND_ENABLED: 'tile-match_sound_enabled',
  /** 게임 최고 점수 / 기록 키 */
  HIGH_SCORE: 'tile-match_high_score',
} as const;
