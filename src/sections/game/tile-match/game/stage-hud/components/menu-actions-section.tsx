    ...
    <div className="flex flex-col gap-1.5 relative z-10">
      ...
      {isLocal && (
        <button
          ...
          className="w-full py-2 px-3.5 bg-amber-100/90 hover:bg-amber-200 active:scale-[0.98] text-amber-950 font-black text-xs sm:text-sm rounded-2xl border border-amber-300 flex items-center justify-between transition-all cursor-pointer shadow-xs"
        >
          <span className="flex items-center gap-2">
            <span>✏️</span> 에디터로 이동
          </span>
          <span className="text-xs bg-amber-600 text-white px-1.5 py-0.5 rounded-md font-extrabold">
            LOCAL
          </span>
        </button>
      )}
