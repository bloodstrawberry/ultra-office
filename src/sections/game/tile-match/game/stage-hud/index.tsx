...
export default function GameStageHud({
  ...
  const [showRestartConfirmModal, setShowRestartConfirmModal] = React.useState<boolean>(false);
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-lg sm:max-w-xl md:max-w-2xl px-3 flex items-center justify-between gap-2 sm:gap-4 relative z-30">
        ...
        {/* Center Left: 남은 턴 Wooden Signboard */}
        <WoodSignBoard
          label="남은 턴"
          value={
        ...
        {/* Center Right: 남은 블록 Wooden Signboard */}
        <WoodSignBoard
          label="남은 블록"
          value={
            <div className="flex items-center gap-1.5">
