      ...
      <div className="w-full max-w-4xl flex items-center justify-between z-10 py-2 sm:py-3 gap-2 shrink-0">
        ...
        {isLocalEnv && (
          <button
            ...
            className="px-3.5 py-2 sm:px-4 sm:py-2.5 bg-amber-500 hover:bg-amber-600 active:scale-95 text-white font-black text-xs sm:text-sm rounded-2xl shadow-md border-2 border-amber-600 flex items-center gap-1.5 transition-all cursor-pointer"
          >
            <span>✏️</span>
            <span>에디터</span>
          </button>
