...
import realMapJson from '../level/real-map.json';
import testMapJson from '../level/test-map.json';
...
export const BUILTIN_LEVELS: LevelData[] = realMap.map((lvl) => ({
  ...
  statusMap: lvl.statusMap,
  turnLimit: lvl.turnLimit ?? 30,
...
export const copyStatusMap = (src?: number[][]): number[][] | undefined => {
