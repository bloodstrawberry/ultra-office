...
export { BUILTIN_LEVELS, SHOOTER_INTERVAL, AUTO_WALL_TURN_DELAY_TICKS } from '../utils/types';
// ── Re-export public types & constants from modules ──
export type { Bullet, CellType, Position, LevelData } from '../utils/types';

import { playEngineSound } from '../utils/sound';
import { useEditorEngine } from '../utils/editor-logic';
import { useGameUndo, useUndoHotkey, type UndoSnapshot } from '../utils/use-game-undo';
import {
  realMap,
  copyGrid,
  type Bullet,
