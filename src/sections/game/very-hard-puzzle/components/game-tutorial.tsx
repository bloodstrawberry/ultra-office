...
export default function GameTutorial({
  ...
  useEffect(() => {
    ...
    const handleIntercept = (e: Event) => {
      ...
      // The tutorial only controls interactions inside its game, not the dashboard navigation.
      const gameRoot = document.querySelector('.very-hard-puzzle-root');
      if (!gameRoot?.contains(targetNode)) return;
